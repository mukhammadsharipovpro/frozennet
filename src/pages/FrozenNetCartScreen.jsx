...
import FrozenNetCartItemComponent from '../components/FrozenNetCartItemComponent';
import FrozenNetComponent from '../components/FrozenNetComponent';
        ...
        <>
          <View style={{height: height * 0.7}}>
            <ScrollView style={styles.flex} contentContainerStyle={styles.main}>
              {cart.map((item, index) => (
                <FrozenNetCartItemComponent item={item} key={index} />
              ))}
            </ScrollView>
          </View>
        </>
